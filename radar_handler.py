...
class CollectionThread(threading.Thread):
    def __init__(self, threadID, name, radarBuffer, stopEvent,radarSettings, radarIP='192.168.7.2', simulate = False, filePaths = None, fs=17, baseband=False,
...
class CollectionThreadX4MP(multiprocessing.Process):
    def __init__(self,threadID, name, stopEvent, radarSettings, baseband = False, fs = 17, radarPort='/dev/ttyACM0', dataQueue=None):
